//Made By https://twitter.com/InPlanaria
//Mit License
//2022/01/06
//need UdonSharp and VRCSDK3-World
...
public class ObjectToggleGlobal : UdonSharpBehaviour
{
    ...
    [Header("")]
    [Header("一度active化したら戻さない場合チェック")]
    [Header("Check if you don't want to put it back once you activate it.")]
    public bool DisallowInactivate = false;
    ...
    public void SetActEvent()//これを別のUdonBehaviourからSendCustomEventで呼んだりしてもいい
    {
        ...
        if(!Networking.IsOwner(gameObject)){
            if(!DisallowInactivate)activated = !activated;
            else activated = true;
